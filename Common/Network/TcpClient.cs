...
namespace Common.Network {
    ...
    public class TcpClient : IClient {
        ...
        private readonly Action<IClient, Header, byte[]> _onReceive;
        ...
        public TcpClient(string address, int port, Action<IClient, Header, byte[]> onReceive) {
            sock = new mSock(System.Net.Sockets.SocketType.Stream, System.Net.Sockets.ProtocolType.Tcp);
        ...
        public void Listen() {
            while(sock.Connected) {
                try {
                    ...
                    _pool.PendTask(() => { _onReceive(this, header, buff); });
